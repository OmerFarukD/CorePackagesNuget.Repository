...
using QubitTech.Repositories.Configuration;
using QubitTech.Repositories.Interceptors;
using QubitTech.Repositories.Services;
using QubitTech.Repositories.UnitOfWorkPattern;

namespace QubitTech.Repositories.Extensions;

/// <summary>
/// IServiceCollection extension methods for QubitTech.Repositories
/// </summary>
